// COVID19 REGISTRATION SYSTEM USING FILE HANDLING BY ABDUL HAKIM
...
void covid_management::menu()
{
    ...
    case 3:
        system("cls");
        cout << "\n\n\t\t\t COVID19 REGISTRATION SYSTEM BY ABDUL HAKIM";
        Sleep(10);
        exit(0);
    default:
...
void covid_management::admin_password()
{
    ...
    cout << "\n\n\t\tEnter Valid Captcha: ";
    cin >> capta;
    if ((strcmp(a_name, "abdulhakim") == 0) && (strcmp(a_password, "abcrs") == 0) && (capt == capta))
    {
        cout << "\n\n\n\t\t\t\t\t| Verfiying ADMIN |\n\t\t\t\t\t";
        for (int a = 1; a < 8; a++)
        {
